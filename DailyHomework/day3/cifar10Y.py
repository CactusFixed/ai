...
# %%
# Code here!
print('train_images: {}'.format(np.shape(train_images)))
print('train_labels: {}'.format(np.shape(train_labels)))
print('test_images: {}'.format(np.shape(test_images)))
print('test_labels: {}'.format(np.shape(test_labels)))
